...
function letterAnimation(el, cls) {
  ...
  const hoveredEl = el.parentElement.parentElement.parentElement.previousElementSibling;
  hoveredEl.addEventListener('mouseenter', (event) => el.animation.play());
  hoveredEl.addEventListener('mouseout', (event) => el.animation.reverse());
}
